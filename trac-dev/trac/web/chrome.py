...
class Chrome(Component):
    ...
    mainnav_order = ListOption('trac', 'mainnav',
                               'home,wiki,timeline,roadmap,browser,tickets,'
                               'newticket,search', doc=
        """Order of the items to display in the `mainnav` navigation bar, 
           listed by IDs. See also TracNavigation.""")

    logo_link = Option('header_logo', 'link', 'http://code.taobao.org',
        """URL to link to from header logo.""")

    logo_src = Option('header_logo', 'src', 'http://code.taobao.org/static/themes/default/images/labs_logo.gif',
    ...
    show_ip_addresses = BoolOption('trac', 'show_ip_addresses', 'true',
...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <!--! Custom match templates go here -->
    ...
    def populate_data(self, req, data):
        ...
        d['trac'] = {
            'version': VERSION,
            'homepage': 'http://code.taobao.com/', # FIXME: use setup data
